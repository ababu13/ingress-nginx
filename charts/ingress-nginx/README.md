...
| controller.admissionWebhooks.createSecretJob.volumeMounts | list | `[]` | If any volume mounts to set |
| controller.admissionWebhooks.createSecretJob.volumes | list | `[]` | If any volumes to set |
...
| controller.admissionWebhooks.patchWebhookJob.volumeMounts | list | `[]` | If any volume mounts to set |
| controller.admissionWebhooks.patchWebhookJob.volumes | list | `[]` | If any volumes to set |
